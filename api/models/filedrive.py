...
class Filedrive(db.Model):
    ...
    def getIsCommon(self):
        ...
        if self.is_common == self.IS_COMMON:
            isCommon = {
                "text": "Common",
                "value": self.IS_COMMON,
                "color": "#108ee9"
            }
        elif self.IS_NOT_COMMON == self.IS_NOT_COMMON:
            isCommon = {
                "text": "Not Common",
                "value": self.IS_NOT_COMMON,
                "color": ""
            }
        else:
            isCommon = {}
    ...
    def getCommonList():
        return [{
            "text": "Common",
            "value": Filedrive.IS_COMMON,
            "color": "#108ee9"
        }, {
            "text": "Not Common",
            "value": Filedrive.IS_NOT_COMMON,
            "color": ""
        }]
